...
export const AddTask: FC<Props> = ({listId}) => {
    ...
    const handleTaskChange = (event: ChangeEvent<HTMLInputElement>, key: string) => {
    ...
    return <div>
        <ListItemButton className={styles.addContainer} onClick={() => setOpen(!open)}>
        ...
        <Collapse in={open} timeout="auto" unmountOnExit>
            <form onSubmit={createTask}>
                ...
                <InputField
                    ...
                    color={theme.palette.secondary.contrastText}
                />
                <Button type="submit" variant="contained" color="primary" startIcon={<TaskAltIcon/>}
